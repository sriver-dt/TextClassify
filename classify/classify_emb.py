...
from task.emb.embNet import EmbNet
from task.emb.dataset import get_dataloader
...
def training():
    ...
    save_dir = os.path.join(FILE_ROOT_DIR, '../output/emb/modules')
    log_dir = os.path.join(FILE_ROOT_DIR, f'../output/emb/log/{now_str}')
    ...
    net = EmbNet(vocab_size=vocab_size, hidden_size=hidden_size, num_classes=num_classes)
